...
public class MainActivity extends ServiceActivity implements View.OnClickListener,
    ...
    private void init() {
        ...
        mButtonLed = findViewById(R.id.bt_led);
        mButtonLed.setOnClickListener(this);

        mImageViewBatteryLevel = findViewById(R.id.iv_battery);
        mTextViewSignalLevel = findViewById(R.id.tv_signal);
        mTextViewDeviceName = findViewById(R.id.tv_device_name);
        mTextViewDeviceConnectionState = findViewById(R.id.tv_device_connection_state);
        mTextViewDeviceBondState = findViewById(R.id.tv_device_bond_state) ;
        mTextViewVersionNumber = findViewById(R.id.tv_device_info);
        mLayoutFeatures = findViewById(R.id.ll_features_buttons);
        mSBTextView = findViewById(R.id.tv_snack_bar);
        mSBChronometer = findViewById(R.id.c_snack_bar);
